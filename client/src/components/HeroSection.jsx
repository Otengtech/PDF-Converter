...
import { FiArrowRight, FiFileText, FiShield, FiZap } from 'react-icons/fi';

const HeroSection = () => {
  return (
    <section id="home" className="max-w-7xl mx-auto px-6 lg:px-8 py-16 md:py-24">
      <div className="text-center animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <button className="group px-8 py-4 bg-slate-800 text-white rounded-full hover:bg-slate-900 transition-all flex items-center justify-center space-x-2 text-sm font-light">
            <span>Get Started</span>
            <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="px-8 py-4 border border-slate-200 text-slate-700 rounded-full hover:border-slate-300 hover:bg-white/50 transition-all text-sm font-light backdrop-blur-sm">
            Learn More
          </button>
        </div>
